...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { artist: @release.artist, description: @release.description, name: @release.name, release: @release.release } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { artist: @release.artist, description: @release.description, name: @release.name, release: @release.release } }
